...
t_series$ts_scale_to_period = 8760/tp # number of timeseries per period
...
# This spits out an error, but that's ok as long as t_points is correct
...
# Recall PLEXOS_zone_data <- cbind.data.frame(Z1_data, Z2_data[5], Z3_data[5], Z4_data[5])
